...
use yral_spacetime_bindings::{
    ...
    spacetimedb_sdk::{DbContext, Status, TimeDuration},
};
...
impl WrappedContext {
    pub async fn new() -> anyhow::Result<Self> {
        ...
        conn.reducers
            .on_mark_airdrop_claimed(move |event, user_principal, duration| {
    ...
    pub async fn mark_airdrop_claimed(
        ...
        self.conn
            .reducers
            .mark_airdrop_claimed(user_principal.to_text(), duration.into())
