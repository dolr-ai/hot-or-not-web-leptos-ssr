...
use yral_spacetime_bindings::{
    autogenerated::backend::{self, mark_airdrop_claimed, NotificationTableAccess},
...
pub fn get_notitfication(
    user_principal: Principal,
    client: &yral_spacetime_bindings::autogenerated::backend::DbConnection,
) -> Result<
    Vec<yral_spacetime_bindings::autogenerated::backend::notification_data_type::NotificationData>,
    ServerFnError,
> {
    let notifications = client
        ...
        .notification()
        .user()
        .find(&yral_spacetime_utils::identity_from_principal(
            user_principal,
        ))
